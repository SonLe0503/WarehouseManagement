        ...
        <div className="p-4">
            ...
            <div className="border-[0.05px] border-gray-300">
                <div className="grid grid-cols-6 bg-gray-100 font-semibold text-sm text-center">
                    ...
                    <div className="px-3 py-2">Số lượng yêu cầu</div>
                    <div className="px-3 py-2">Số lượng nhận</div>
                ...
                {(request.items || []).length === 0 ? (
                    ...
                    request.items!.map((item) => (
                        <div key={item.id} className="grid grid-cols-6 text-center text-sm border-b-[0.05px] border-gray-300 items-center hover:bg-gray-50">
                            <div className="px-3 py-2">{item.product?.name || `SP #${item.productId}`}</div>
                            <div className="px-3 py-2">{item.product?.sku || "—"}</div>
