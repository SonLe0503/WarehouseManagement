    ...
    return (
        ...
        >
            <div className="flex flex-col gap-4">
                <Text>
                    Bạn có chắc chắn muốn {action === "Approve" ? <span className="text-green-600 font-bold">duyệt</span> : <span className="text-red-600 font-bold">từ chối</span>} phiếu nhập này không?
                </Text>
